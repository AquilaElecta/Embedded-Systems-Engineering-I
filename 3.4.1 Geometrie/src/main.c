...
void OLED_drawSinus(void);
void OLED_drawKreis(void);
...
void OLED_drawSinus(void){
  display[0]=0x40; //control byte for data
  for(int x=0;x<128;x++){
    int y = (int)(31.5 + 31.5*sin((float)x*2*3.14159/128.0));//Die Mitte des Displays ist Koordinatenursprung
    OLED_drawPixel(x,y);
  }
}
void OLED_drawKreis(void){
  ...
  for(float t=0;t<2*3.14159;t+=0.01){
    int x = (int)(63.5 + 31.5*cos(t));
    int y = (int)(31.5 + 31.5*sin(t));
    OLED_drawPixel(x,y);
  }
}
